...
public class KhuyenMaiDTO {
    ...
    public KhuyenMaiDTO(String IDKhuyenMai, String TenChuongTrinh, float TienGiam, LocalDate NgayBatDau, LocalDate NgayKetThuc, String NoiDungGiamGia, String TrangThai) {
    ...
    public KhuyenMaiDTO(String IDKhuyenMai, String TenChuongTrinh, float TienGiam, LocalDate NgayBatDau, LocalDate NgayKetThuc, String NoiDungGiamGia) {
        this.IDKhuyenMai = IDKhuyenMai;
        this.TenChuongTrinh = TenChuongTrinh;
        this.TienGiam = TienGiam;
        this.NgayBatDau = NgayBatDau;
