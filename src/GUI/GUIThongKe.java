...
public class GUIThongKe extends JPanel {
    ...
    public GUIThongKe() throws Exception {
        ...
        tabs.addTab("Biểu đồ thống kê", getIcon("icons8_bar_chart_30px.png"), null);
...
class ThongKe_Hoang extends JPanel {
    ...
    JTextField txBieuDo = new JTextField(10);
    ...
    MoreButton btnBieuDo = new MoreButton();
    ...
    JPanel plMonAn, plNhanVien, plKhachHang, plNhaCC,plNguyenlieu, plBieuDo;
    ...
    public ThongKe_Hoang() throws Exception {
        ...
        btnBieuDo.addActionListener((ae) -> {
            GUIFormChon a = null;
             try {
                 a = new GUIFormChon(txBieuDo,"Biểu đồ");
             } catch (Exception ex) {
                 Logger.getLogger(GUIThongKe.class.getName()).log(Level.SEVERE, null, ex);
             }
             a.setVisible(true);    
        ...
        plBieuDo = getPanelTieuChi("Biểu đồ", txBieuDo, btnBieuDo);
