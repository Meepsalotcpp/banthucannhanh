...
public class HoaDonDAO {
        ...
        try {
            ...
            if (result != null) {
                while (result.next()) {
                    ...
                    hd.setTienTra(result.getFloat("TienTra"));
                    hd.setTienThoi(result.getFloat("TienThoi"));
    ...
    public void them(HoaDonDTO HD) { //cần ghi lại khi qua class khác
        try {
            ...
            qry = qry + "," + "'" + HD.getTienTra()+ "'";
            qry = qry + "," + "'" + HD.getTienThoi()+ "'";
    ...
    public void sua(HoaDonDTO HD) { //cần ghi lại khi qua class khác
        try {
            ...
            qry = qry + ",TienTra=" + "'" + HD.getTienTra()+ "'";
            qry = qry + ",TienThoi=" + "'" + HD.getTienThoi()+ "'";
            qry = qry+" "+" WHERE IDHoaDon=' "+HD.getIDHoaDon()+"'";
            connection.getStatement();
            connection.ExecuteUpdate(qry);
            System.out.println(qry);
